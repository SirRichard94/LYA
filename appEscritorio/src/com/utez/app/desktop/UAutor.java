 ...
 * @author Koffo
 */
public class UAutor extends javax.swing.JFrame {
    ...
    public UAutor() {
        try {
            ...
            Logger.getLogger(UAutor.class.getName()).log(Level.SEVERE, null, ex);
        }

        initComponents();
    }
    
    public UAutor(AutorBean consultaBean){
        this();
...
//      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
