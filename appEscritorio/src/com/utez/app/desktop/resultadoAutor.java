...
public class resultadoAutor extends javax.swing.JFrame {
    ...
    private void actualizarTabla(){
        modelo= new DefaultTableModel (new String[]{"Autor_id","Nombre","Apellido","Num. de Libros"},0){
        ...
        List<AutorBean> lista =daoAutor.getActive();
             for (AutorBean bean : lista) {
                 Object[] arreglo = 
                 {bean.getAutor_id(), bean.getNombre(),bean.getApellido(), new DaoLibro(conexion).countByAutor(bean)};
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
       ...
       // JOptionPane.showMessageDialog(rootPane, id);
        ...
        JFrame jf = new UDAutor(autor); jf.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
	jf.setVisible(true);
        this.dispose();
