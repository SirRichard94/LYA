...
public class resultadoArea extends javax.swing.JFrame {
    ...
    private void actualizarTabla(){
        modelo= new DefaultTableModel (new String[]{"Area_id","Nombre","Num de Libros"},0){
        ...
        List<AreaBean> lista =daoArea.getActive();
             for (AreaBean bean : lista) {
                 Object[] arreglo = 
                 {bean.getArea_id(), bean.getNombre(),bean.isAlta(), new DaoLibro(conexion).countByArea(bean)};
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
       ...
       // JOptionPane.showMessageDialog(rootPane, id);
        ...
        JFrame jf = new UDArea(area); jf.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
	jf.setVisible(true);
        this.dispose();
