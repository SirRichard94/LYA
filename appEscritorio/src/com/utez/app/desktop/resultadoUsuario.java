...
public class resultadoUsuario extends javax.swing.JFrame {
    ...
    private void actualizarTabla(){
        modelo= new DefaultTableModel (new String[]{"usuario_id","nombre","direccion","telefono","correo","Deuda","Préstamos"},0){
            Class[] types = {Integer.class, String.class, String.class, String.class, String.class, Double.class, Integer.class };
        ...
        List<UsuarioBean> lista =daoUsuario.getActive();
             for (UsuarioBean bean : lista) {
                 Object[] arreglo = 
                 {bean.getUsuario_id(), bean.getNombre(),bean.getDireccion(),bean.getTelefono(),bean.getCorreo(),bean.getDeuda(), daoUsuario.countPrestamos(bean)};
    ...
    public void tablaBusqueda(String busqueda){
        if (busqueda.length() < 0) {
            ...
            modelo = new DefaultTableModel(new String[]{"usuario_id", "nombre", "direccion", "telefono", "correo", "deuda", "passwd", "alta", "es_admi"}, 0);

            List<UsuarioBean> lista = daoUsuario.getActive();
            for (UsuarioBean bean : lista) {
                if (bean.getNombre().toLowerCase().contains(busqueda.toLowerCase())) {
                    Object[] arreglo
                            = {bean.getUsuario_id(), bean.getNombre(), bean.getDireccion(), bean.getTelefono(), bean.getCorreo(), bean.getDeuda(), bean.getPasswd(), bean.isAlta(), bean.isEs_admi()};
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla Usuario"));
