...
public class resultadoEditorial extends javax.swing.JFrame {
    ...
    public resultadoEditorial() {
        ...
        modelo= new DefaultTableModel (new String[]{"Editorial_id","Nombre","Direccion","Alta"},0);
        

        List<EditorialBean> lista =daoEditorial.getAll();
             for (EditorialBean bean : lista) {
                 Object[] arreglo = 
                 {bean.getEditorial_id(), bean.getNombre(),bean.getDireccion(),bean.isAlta()};
